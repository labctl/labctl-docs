import{_ as s,o as a,c as n,a as e}from"./app.9570ac09.js";const A=JSON.parse('{"title":"Template Examples","description":"","frontmatter":{},"headers":[{"level":2,"title":"String manupilation","slug":"string-manupilation","link":"#string-manupilation","children":[]}],"relativePath":"guide/template-examples.md","lastUpdated":1663769395000}'),t={name:"guide/template-examples.md"},l=e(`<h1 id="template-examples" tabindex="-1">Template Examples <a class="header-anchor" href="#template-examples" aria-hidden="true">#</a></h1><h2 id="string-manupilation" tabindex="-1">String manupilation <a class="header-anchor" href="#string-manupilation" aria-hidden="true">#</a></h2><p>The following examples perform the same function. They extract a number from the string name of the router.</p><p>The templates marked with asterisk (*) are not ideal, since it assumes you know if the numeric part of the router is one or more digits.</p><div class="language-"><button class="copy"></button><span class="lang"></span><pre><code><span class="line"><span style="color:#A6ACCD;">{{  &quot;PE9&quot;  | slice 2 0 }}</span></span>
