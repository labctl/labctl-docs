import{_ as s,o as a,c as n,a as e}from"./app.9570ac09.js";const A=JSON.parse('{"title":"Getting Started","description":"","frontmatter":{},"headers":[{"level":2,"title":"Installation","slug":"installation","link":"#installation","children":[]},{"level":2,"title":"Run a console command","slug":"run-a-console-command","link":"#run-a-console-command","children":[]},{"level":2,"title":"Start the web server","slug":"start-the-web-server","link":"#start-the-web-server","children":[]}],"relativePath":"guide/getting-started.md","lastUpdated":1663816731000}'),l={name:"guide/getting-started.md"},t=e(`<h1 id="getting-started" tabindex="-1">Getting Started <a class="header-anchor" href="#getting-started" aria-hidden="true">#</a></h1><h2 id="installation" tabindex="-1">Installation <a class="header-anchor" href="#installation" aria-hidden="true">#</a></h2><p>Labctl is distributed as a single executable for Linux based distros</p><div class="getting-started-command"><div class="language-bash"><button class="copy"></button><span class="lang">bash</span><pre><code><span class="line"><span style="color:#A6ACCD;">bash -c </span><span style="color:#89DDFF;">&quot;$(</span><span style="color:#C3E88D;">curl -sL https://labctl.net/get.sh</span><span style="color:#89DDFF;">)&quot;</span></span>
