import{_ as a,o as s,c as e,R as t}from"./chunks/framework.5065ad62.js";const A=JSON.parse('{"title":"Template Examples","description":"","frontmatter":{},"headers":[],"relativePath":"guide/template-examples.md","filePath":"guide/template-examples.md","lastUpdated":1689931974000}'),n={name:"guide/template-examples.md"},l=t(`<h1 id="template-examples" tabindex="-1">Template Examples <a class="header-anchor" href="#template-examples" aria-label="Permalink to &quot;Template Examples&quot;">​</a></h1><h2 id="string-manupilation" tabindex="-1">String manupilation <a class="header-anchor" href="#string-manupilation" aria-label="Permalink to &quot;String manupilation&quot;">​</a></h2><p>The following examples perform the same function. They extract a number from the string name of the router.</p><p>The templates marked with asterisk (*) are not ideal, since it assumes you know if the numeric part of the router is one or more digits.</p><div class="language-jinja"><button title="Copy Code" class="copy"></button><span class="lang">jinja</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">{{  &quot;PE9&quot;  | slice 2 0 }}</span></span>
